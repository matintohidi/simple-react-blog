    ...
    return (
        <>
            <div className="flex flex-col-reverse sm:flex-row justify-between items-center my-4 sm:my-8">
                ...
                <h2 className="text-lg mb-6 sm:mb-0 font-black text-gray-600">{dateFormat.getDate()} , {numToMonth(dateFormat.getMonth())} , {dateFormat.getFullYear()}</h2>
            </div>
            <div className="flex gap-y-4 mt-6 mb-4 justify-between sm:items-center flex-col-reverse sm:flex-row">
