    ...
    return (
        <>
            ...
            <div>
                ...
                {
                    user.isAuthenticated ? <form onSubmit={handleSubmit(createComment)} className="mt-4 flex flex-col justify-center items-center">
                    ...
                    </form> : <div className="text-gray-700 my-6 px-8 py-4 backdropCard rounded-md text-center">If you like to comment, you must log in</div>
                }
            </div>
        </>
    )
