    ...
    return (
        <>
            ...
            <div>
                ...
                {
                    user.isAuthenticated ? <div className="mt-4 flex flex-col justify-center items-center">
                    ...
                    </div> : <div className="text-gray-700 my-6 px-8 py-4 backdropCard rounded-md text-center">If you like to comment, you must log in</div>
                }
            </div>
        </>
    )
