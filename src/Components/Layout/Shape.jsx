...
const Shape = ({ count , shapeDisplay }) => {
    return (
      <>
        ...
        {
            shapeDisplay && <ImageLazy src={Shape6} className={`hidden absolute animate-[bounce_3s_linear_infinite] w-24 h-24 -z-50 top-[125rem] left-28 ${count > 6 ? "lg:block" : "hidden"}`} />
        }
      </>
    )
}
